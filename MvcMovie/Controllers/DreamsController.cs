...
namespace MvcMovie.Controllers
{
    public class DreamsController : Controller
    {
        ...
        public DreamsController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Dream != null ? 
                          ...
                          Problem("Entity set 'MvcMovieContext.Dream'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Kind,Price,PlantTime")] Dream dream)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Kind,Price,PlantTime")] Dream dream)
        {
            if (id != dream.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcMovieContext.Dream'  is null.");
            }
            var dream = await _context.Dream.FindAsync(id);
            if (dream != null)
            {
